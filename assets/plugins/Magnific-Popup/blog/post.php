            ...
            <div class="row">
                <div class="full-col col-lg-10 col-md-10 col-md-push-1">
                    <div class="posts-nav">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="#" class="nav_prev nav-btn td-none" style="background-image: url('../assets/images/blog/blog-img-1.jpg');">
                                    <div class="nav_content">
                                        <div class="fsize-14 fweight-700 uppercase color-1">Previous Post</div>
                                        <div class="nav-title font-agency fsize-24 fweight-700 color-white uppercase">Shirloin leberkas pig, rump ham hock tail shank burgdogen</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="#" class="nav_next nav-btn td-none" style="background-image: url('../assets/images/blog/blog-img-2.jpg');">
                                    <div class="nav_content">
                                        <div class="fsize-14 fweight-700 uppercase color-1">Next Post</div>
                                        <div class="nav-title font-agency fsize-24 fweight-700 color-white uppercase">Meatlof strip steak ball tip venison prosciuto shankle</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="p60">
                                ...
                                <div class="clearfix">
                                    <p class="col-lg-4 col-md-4 col-sm-12 col-sm-12 m0">
                                        <img src="../assets/images/post/post-small-1.jpg" alt="" class="img-responsive mlr-auto mb20">
                                    </p>
                                    <p class="col-lg-4 col-md-4 col-sm-12 col-sm-12 m0">
                                        <img src="../assets/images/post/post-small-2.jpg" alt="" class="img-responsive mlr-auto mb20">
                                    </p>
                                    <p class="col-lg-4 col-md-4 col-sm-12 col-sm-12 m0">
                                        <img src="../assets/images/post/post-small-3.jpg" alt="" class="img-responsive mlr-auto mb20">
                                    </p>
                                </div>
                                <p class="mt30">
                                ...
                                <ul class="list-1">
                                    ...
                                    <li class="color5">
                                        Short ribs kevin tri-tip burgdoggen.
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="post-commet-bl col-lg-12">
                            ...
                            <div class="comment-wrapper mt30">
                                <div class="comment_list parrent">
                                                ...
                                                <div class="table">
                                                    <div class="comment-meta fsize-0">
                                                        ...
                                                        <div class="fsize-14 fweight-700">
                                                            <div class="fsize-12 color-9 uppercase">Mar 22, 2018</div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="comment_list children">
                                        <div class="comment-body">
                                            <div class="table-row">
                                                <div class="comment-left">
                                                    <img src="../assets/images/post/comment-author-2.jpg" alt="">
                                                </div>
                                                <div class="comment-right">
                                                    <div class="table">
                                                        <div class="comment-meta fsize-0">
                                                            <div>
                                                                <a href="#" class="author-url">Genevieve Mcdonald</a>
                                                                <a href="#comment-form" class="reply">Reply</a>
                                                            </div>
                                                            <div class="fsize-14 fweight-700">
                                                                <div class="fsize-12 color-9 uppercase">Mar 22, 2018</div>
                                                    ...
                                                    <div class="comment-text mt20 lheight-26">
                                                        Steak sausage pork loin bacon tri-tip meatball shoulder cupim beef pork chop kevin boudin. Short loin pig meatball ham
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="comment_list children">
                                            <div class="comment-body">
                                                <div class="table-row">
                                                    <div class="comment-left">
                                                        <img src="../assets/images/post/comment-author-3.jpg" alt="">
                                                    </div>
                                                    <div class="comment-right">
                                                        <div class="table">
                                                            <div class="comment-meta fsize-0">
                                                                <div>
                                                                    <a href="#" class="author-url">Jesus Chandler</a>
                                                                    <a href="#comment-form" class="reply">Reply</a>
                                                                </div>
                                                                <div class="fsize-14 fweight-700">
                                                                    <div class="fsize-12 color-9 uppercase">Mar 22, 2018</div>
                                                        ...
                                                        <div class="comment-text mt20 lheight-26">
                                                            Brisket ham hock chuck cupim andouille beef ribs turducken pork belly. Picanha filet mignon tenderloin venison sirloin biltong. Picanha jerky venison chuck, filet mignon sirloin t-bone rump short loin
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
